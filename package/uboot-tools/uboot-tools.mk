...
UBOOT_TOOLS_MAKE_OPTS += CONFIG_FIT_SIGNATURE=n
endif
...
define UBOOT_TOOLS_BUILD_CMDS_TOOLS_ONLY
...
define UBOOT_TOOLS_BUILD_CMDS_ENVTOOLS
	$(TARGET_MAKE_ENV) $(BR2_MAKE) -C $(@D) $(UBOOT_TOOLS_MAKE_OPTS) \
...
define UBOOT_TOOLS_BUILD_CMDS
	$(UBOOT_TOOLS_BUILD_CMDS_TOOLS_ONLY)
	$(UBOOT_TOOLS_BUILD_CMDS_ENVTOOLS)
endef
...
define HOST_UBOOT_TOOLS_BUILD_CMDS
	$(BR2_MAKE) -C $(@D) $(HOST_UBOOT_TOOLS_MAKE_OPTS) tools-only
	$(BR2_MAKE) -C $(@D) $(HOST_UBOOT_TOOLS_MAKE_OPTS) envtools no-dot-config-targets=envtools
