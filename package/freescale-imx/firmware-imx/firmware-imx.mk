...
ifeq ($(BR2_PACKAGE_FIRMWARE_IMX_LPDDR5),y)
...
ifeq ($(BR2_PACKAGE_FIRMWARE_IMX_LPDDR4X),y)
FIRMWARE_IMX_DDR_VERSION_SUFFIX = _v$(FIRMWARE_IMX_DDR_VERSION)
...
ifneq ($(BR2_PACKAGE_FREESCALE_IMX_PLATFORM_IMX91)$(BR2_PACKAGE_FREESCALE_IMX_PLATFORM_IMX93),)
FIRMWARE_IMX_DDR_VERSION_SUFFIX = _v$(FIRMWARE_IMX_DDR_VERSION)
...
define FIRMWARE_IMX_INSTALL_IMAGE_DDR_FW
	...
	# the binary dir.
	$(INSTALL) -D -m 0644 -t $(BINARIES_DIR) \
		$(FIRMWARE_IMX_DDRFW_DIR)/lpddr4_pmu_train*mem$(FIRMWARE_IMX_DDR_VERSION_SUFFIX).bin
endef
endif
endif
...
ifneq ($(BR2_PACKAGE_FREESCALE_IMX_PLATFORM_IMX95),)
define FIRMWARE_IMX_INSTALL_TARGET_VPU_FW
	$(INSTALL) -D -m 0644 -t $(TARGET_DIR)/lib/firmware \
		${@D}/firmware/vpu/wave633c_codec_fw.bin
endef
endif
