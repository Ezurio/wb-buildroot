...
IMX_GPU_VIV_REVISION = b8d4b64
ifeq ($(BR2_aarch64),y)
IMX_GPU_VIV_VERSION = 6.4.11.p4.6-aarch64
else
IMX_GPU_VIV_VERSION = 6.4.11.p4.6-aarch32
endif
...
define IMX_GPU_VIV_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 -t $(TARGET_DIR)/usr/lib/udev/rules.d \
