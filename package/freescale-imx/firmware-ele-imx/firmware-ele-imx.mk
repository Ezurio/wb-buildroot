...
FIRMWARE_ELE_IMX_VERSION = 2.0.4
FIRMWARE_ELE_IMX_REVISION = 93492e0
...
define FIRMWARE_ELE_IMX_INSTALL_IMAGES_CMDS
	$(INSTALL) -D -m 0644 -t $(BINARIES_DIR) $(@D)/$(FIRMWARE_ELE_IMX_AHAB_CONTAINER_IMAGE)
	ln -sf $(FIRMWARE_ELE_IMX_AHAB_CONTAINER_IMAGE) $(BINARIES_DIR)/ahab-container.img
endef
