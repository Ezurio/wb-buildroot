...
ifeq ($(BR2_PACKAGE_LIBUBOOTENV_YAML_CONFIG),y)
LIBUBOOTENV_CONF_OPTS += -DNO_YML_SUPPORT=OFF
LIBUBOOTENV_DEPENDENCIES = libyaml
else
LIBUBOOTENV_CONF_OPTS += -DNO_YML_SUPPORT=ON
endif
