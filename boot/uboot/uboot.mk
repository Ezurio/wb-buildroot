...
UBOOT_MAKE_OPTS += BL31=$(BINARIES_DIR)/bl31.bin BL1=$(BINARIES_DIR)/bl1.bin
define UBOOT_COPY_ATF_FIRMWARE
...
else ifeq ($(BR2_TARGET_UBOOT_NEEDS_OPTEE_V2_TEE_BIN),y)
UBOOT_MAKE_OPTS += TEE=$(BINARIES_DIR)/tee-pager_v2.bin
define UBOOT_COPY_OPTEE_TEE
	cp $(BINARIES_DIR)/tee-pager_v2.bin $(@D)/tee.bin
endef
UBOOT_PRE_BUILD_HOOKS += UBOOT_COPY_OPTEE_TEE
endif
endif
...
define UBOOT_COPY_ELE_IMX_FIRMWARE
ln -sf $(BINARIES_DIR)/$(BR2_PACKAGE_FIRMWARE_ELE_IMX_AHAB_CONTAINER_IMAGE) $(@D)
endef
UBOOT_PRE_BUILD_HOOKS += UBOOT_COPY_ELE_IMX_FIRMWARE
endif
...
define UBOOT_COPY_IMX_SM_FIRMWARE
ln -sf $(BINARIES_DIR)/m33_image.bin $(@D)
endef
UBOOT_PRE_BUILD_HOOKS += UBOOT_COPY_IMX_SM_FIRMWARE
endif
endif
...
UBOOT_DEPENDENCIES += host-pkcs11-provider host-aws-kms-pkcs11
UBOOT_MAKE_OPTS += \
